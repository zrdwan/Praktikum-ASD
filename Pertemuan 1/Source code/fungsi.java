...
public class fungsi {
    public static void main(String[] args) {
        ...
        do{
            ...
            System.out.print("\nPilihan Menu Anda(1 / 2 / 3) : ");
            menu = sc.nextInt();
            switch(menu){
                case 1 : {
                    System.out.println("\nMenu 1. Menampilkan Stock Bunga");
                    menampilkanStockBunga();
                }break;
                case 2 : {
                    System.out.println("\nMenu 2. Menampilkan seluruh stock bunga di seluruh cabang");
    ...
    private static void menampilkanStockBunga() {
        ...
        System.out.println("Jumlah Bunga Algonema   : " + aglonema);
